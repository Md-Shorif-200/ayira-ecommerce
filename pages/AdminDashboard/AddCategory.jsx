      ...
      >
        ...
        <div className="w-[180px] flex items-center gap-4 pt-4">
          <button
            ...
            className="w-full flex items-center justify-center px-6 py-2 bg-yellow-400 text-gray-800 font-semibold rounded-md hover:bg-yellow-500 focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:ring-opacity-75 disabled:opacity-70 cursor-pointer"
          >
            {isSubmitting ? (
              <>
