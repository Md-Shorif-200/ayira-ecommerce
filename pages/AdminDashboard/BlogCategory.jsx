...
const BlogCategory = () => {
  ...
  useEffect(() => {
    const fetchCategories = async () => {
      const res = await axios.get("https://ayira-ecommerce-backend.vercel.app/categories");
  ...
  const handleAddCategory = async (newValue) => {
    const res = await axios.post("https://ayira-ecommerce-backend.vercel.app/categories", { value: newValue });
  ...
  const handleDeleteCategory = async (id) => {
    await axios.delete(`https://ayira-ecommerce-backend.vercel.app/categories/${id}`);
