      ...
      >
        ...
        <div className="flex flex-col flex-grow px-5 py-3">
          ...
          <div className="flex flex-wrap gap-2 mb-3">
            <span className="bg-green-100 text-green-700 text-xs font-medium px-3 py-1 rounded-full uppercase">
              {product?.productCategory}
            </span>
            <span className="bg-purple-100 text-purple-700 text-xs font-medium px-3 py-1 rounded-full uppercase">
    ...
    >
      ...
      <div className="px-4 py-2 flex flex-col ">
        ...
        <div className="flex flex-wrap gap-x-2 my-2 ">
          <span className="bg-gradient-to-r from-blue-50 to-indigo-50 text-blue-700 text-xs font-semibold px-3 py-1.5 rounded-full border border-blue-200 uppercase">
            {product?.productCategory}
          </span>
          <span className="bg-gradient-to-r from-green-50 to-emerald-50 text-green-700 text-xs font-semibold px-3 py-1.5 rounded-full border border-green-200 uppercase">
        ...
        <div className="flex justify-between items-center">
          <div className="flex items-center gap-1">
            <span className="text-xs text-gray-500 uppercase tracking-wide font-medium  mt-2">
              Size :
            </span>
